...
require "./handler/register-handler.php";
...
<body>
    ...
    <div class="primary-main">
        <div class="primary-container">
            <h1 class="header">
                <span>B L</span>
                <span class="sub-login">signup</span>
            </h1>
            <div class="form-box">
                <form action="" method="post">
                    ...
                    <input type="submit" class="btn-submit" value="signup" name="submit" >
                </form>
            </div>
        </div>
    </div>
